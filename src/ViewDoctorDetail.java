...
public class ViewDoctorDetail {
    ...
    boolean isAdminMode;
    public ViewDoctorDetail(HospitalController refgHC, boolean  admMod)
    {
        HC= refgHC;
        initGUI();
        isAdminMode = admMod;
    ...
    public void initGUI()
    {
        docFrame = new JFrame("View Doctor Info");
        docFrame.setLayout(new BorderLayout());
        
        msgText = new JLabel("View Doctor Info");
        ...
        btnSignOut.setActionCommand("61");
        ...
        tableScroller = new JScrollPane(docTable);
        scrollTBPanel = new JPanel(new BorderLayout());
        scrollTBPanel.add(tableScroller);
        
        //-------------------------------------
        
        docFrame.add(msgPanel, BorderLayout.NORTH);
        docFrame.add(scrollTBPanel, BorderLayout.CENTER);
        docFrame.add(btnPanel, BorderLayout.SOUTH);
        
        docFrame.setSize(1200,500);
